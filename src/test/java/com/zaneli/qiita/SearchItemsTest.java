...
public class SearchItemsTest {
  ...
  @Test
  public void 検索結果取得成功_1件(@Mocked("execute") QiitaExecutor executor) throws Exception {
    QiitaClientTestUtil.configureMock(executor, SC_OK, "ItemInfo.json");
    QiitaClient client = new QiitaClient();
    ItemInfo[] infos = client.searchItems(new SearchRequest("Java", "Python", "Haskell")).getContents();
  ...
  @Test
  public void 検索結果取得成功_複数件(@Mocked("execute") QiitaExecutor executor) throws Exception {
  ...
  @Test
  public void 検索結果取得失敗(@Mocked("execute") QiitaExecutor executor) throws Exception {
    SearchRequest req = new SearchRequest("Java", "Python", "Haskell");
    QiitaClientTestUtil.configureMock(executor, SC_BAD_REQUEST, "Error.json");
    QiitaClient client = new QiitaClient();
    try {
      client.searchItems(req);
